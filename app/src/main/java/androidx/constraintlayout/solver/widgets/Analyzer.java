...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        while (it.hasNext()) {
            i12 = Math.max(i12, getMaxDimensionTraversal(((ResolutionAnchor) it.next()).myAnchor.mOwner, i, z, i14));
        }
        Iterator<ResolutionNode> it2 = constraintWidget.mListAnchors[i7].getResolutionNode().dependents.iterator();
        int i15 = 0;
        while (it2.hasNext()) {
            it2 = it2;
            i15 = Math.max(i15, getMaxDimensionTraversal(((ResolutionAnchor) it2.next()).myAnchor.mOwner, i, z, width2 + i14));
        }
        if (z2) {
            i12 -= i6;
            width = i15 + i5;
        ...
        if (i == 1) {
            ...
            i9 = i7;
            int i18 = i17;
            i10 = (constraintWidget.mBaseline.getResolutionNode().dependents.size() <= 0 || z2) ? i18 : i8 == 1 ? i18 + i6 : i18 - i5;
        } else {
            i9 = i7;
            i10 = 0;
        }
        ...
        if (z) {
            ...
            constraintWidget.setFrame(i14, i19, i);
        } else {
    ...
    private static int resolveDimensionRatio(ConstraintWidget constraintWidget) {
        ...
        if (constraintWidget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            if (constraintWidget.mDimensionRatioSide == 0) {
                f2 = constraintWidget.getHeight() * constraintWidget.mDimensionRatio;
            } else {
                f2 = constraintWidget.getHeight() / constraintWidget.mDimensionRatio;
            }
            int i = (int) f2;
            ...
            if (constraintWidget.mDimensionRatioSide == 1) {
                f = constraintWidget.getWidth() * constraintWidget.mDimensionRatio;
            } else {
                f = constraintWidget.getWidth() / constraintWidget.mDimensionRatio;
            }
            int i2 = (int) f;
