...
import androidx.recyclerview.C0239R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0239R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0239R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0239R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0239R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0239R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0239R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0239R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0239R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (dispatchNestedScroll(i3, i6, i5, i4, this.mScrollOffset, 0)) {
            ...
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                pullGlows(motionEvent.getX(), i5, motionEvent.getY(), i4);
            }
            considerReleasingGlowsOnScroll(i, i2);
        }
        if (!(i3 == 0 && i9 == 0)) {
            dispatchOnScrolled(i3, i9);
        }
        if (!awakenScrollBars()) {
            invalidate();
        }
        return (i3 == 0 && i9 == 0) ? false : true;
    }
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* JADX WARN: Removed duplicated region for block: B:103:0x0230 A[ADDED_TO_REGION] */
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0239R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0239R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0239R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0239R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0239R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0239R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0239R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0239R.dimen.fastscroll_margin));
    }
