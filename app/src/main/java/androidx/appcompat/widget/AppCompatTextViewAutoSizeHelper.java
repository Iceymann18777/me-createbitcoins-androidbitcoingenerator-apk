...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(C0002R.styleable.AppCompatTextView_autoSizePresetSizes) && (resourceId = obtainStyledAttributes.getResourceId(C0002R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
