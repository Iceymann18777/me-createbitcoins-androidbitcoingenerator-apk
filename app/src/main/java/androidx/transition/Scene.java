...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup viewGroup, int i, Context context) {
        SparseArray sparseArray = (SparseArray) viewGroup.getTag(C0331R.C0333id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            viewGroup.setTag(C0331R.C0333id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    public static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0331R.C0333id.transition_current_scene, scene);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0331R.C0333id.transition_current_scene);
    }
