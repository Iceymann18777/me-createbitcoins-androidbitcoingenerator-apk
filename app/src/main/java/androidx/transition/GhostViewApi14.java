...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final ViewTreeObserver.OnPreDrawListener mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: androidx.transition.GhostViewApi14.1
    ...
    private static void setGhostView(View view, GhostViewApi14 ghostViewApi14) {
        view.setTag(C0331R.C0333id.ghost_view, ghostViewApi14);
    }

    static GhostViewApi14 getGhostView(View view) {
        return (GhostViewApi14) view.getTag(C0331R.C0333id.ghost_view);
    }
}
