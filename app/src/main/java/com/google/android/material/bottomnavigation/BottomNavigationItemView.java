...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0369R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0369R.C0370drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0369R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0369R.C0371id.icon);
        this.smallLabel = (TextView) findViewById(C0369R.C0371id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0369R.C0371id.largeLabel);
