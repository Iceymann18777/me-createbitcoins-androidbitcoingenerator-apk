...
import com.google.android.material.animation.C0369R;
...
public class AppBarLayout extends LinearLayout {
    ...
    private List<BaseOnOffsetChangedListener<AppBarLayout>> listeners;
    private int pendingAction;
    private int[] tmpStatesArray;
    private int totalScrollRange;
    private BaseOnOffsetChangedListener<AppBarLayout> baseOnOffsetChangedListener;
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C0369R.style.Widget_Design_AppBarLayout);
        }
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0369R.styleable.AppBarLayout, 0, C0369R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(C0369R.styleable.AppBarLayout_android_background));
        int AppBarLayout_expanded = 0;
        if (obtainStyledAttributes.hasValue(AppBarLayout_expanded)) {
            setExpanded(obtainStyledAttributes.getBoolean(C0369R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && obtainStyledAttributes.hasValue(C0369R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, obtainStyledAttributes.getDimensionPixelSize(C0369R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (obtainStyledAttributes.hasValue(C0369R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(obtainStyledAttributes.getBoolean(C0369R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (obtainStyledAttributes.hasValue(C0369R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(obtainStyledAttributes.getBoolean(C0369R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = obtainStyledAttributes.getBoolean(C0369R.styleable.AppBarLayout_liftOnScroll, false);
    ...
    public void addOnOffsetChangedListener(BaseOnOffsetChangedListener<AppBarLayout> baseOnOffsetChangedListener) {
    ...
    public void addOnOffsetChangedListener(OnOffsetChangedListener onOffsetChangedListener) {
        addOnOffsetChangedListener((BaseOnOffsetChangedListener<AppBarLayout>) onOffsetChangedListener);
    }

    public void removeOnOffsetChangedListener(BaseOnOffsetChangedListener<AppBarLayout> baseOnOffsetChangedListener) {
        List<BaseOnOffsetChangedListener<AppBarLayout>> list = this.listeners;
    ...
    public void removeOnOffsetChangedListener(OnOffsetChangedListener onOffsetChangedListener) {
        removeOnOffsetChangedListener((BaseOnOffsetChangedListener<AppBarLayout>) onOffsetChangedListener);
    }
    ...
    void dispatchOffsetUpdates(int i) {
        ...
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                BaseOnOffsetChangedListener<AppBarLayout> baseOnOffsetChangedListener = this.listeners.get(i2);
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C0369R.attr.state_liftable : -C0369R.attr.state_liftable;
        iArr[1] = (!this.liftable || !this.lifted) ? -C0369R.attr.state_lifted : C0369R.attr.state_lifted;
        iArr[2] = this.liftable ? C0369R.attr.state_collapsible : -C0369R.attr.state_collapsible;
        iArr[3] = (!this.liftable || !this.lifted) ? -C0369R.attr.state_collapsed : C0369R.attr.state_collapsed;
        return mergeDrawableStates(onCreateDrawableState, iArr);
    }

    public boolean setLiftable() {
        return setLiftable();
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.scrollFlags = 1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0369R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C0369R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C0369R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0369R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            obtainStyledAttributes.recycle();
        }
    ...
    public static class Behavior extends BaseBehavior<AppBarLayout> {
        ...
        @Override // com.google.android.material.appbar.AppBarLayout.BaseBehavior
        public /* bridge */ /* synthetic */ void setDragCallback(BaseDragCallback<T> baseDragCallback) {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private BaseDragCallback<T> onDragCallback;
        ...
        public void setDragCallback(BaseDragCallback<T> baseDragCallback) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0369R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0369R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
    ...
    private class AppBarLayout_expanded {
    }
}
